...
CREATE TABLE categoria_atributos (
    ...
    tipo_dato ENUM('texto', 'numero', 'lista', 'booleano', 'fecha') NOT NULL,
    obligatorio TINYINT(1) NOT NULL DEFAULT 0,
    filtrable TINYINT(1) NOT NULL DEFAULT 0,
    genera_variantes TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE categoria_atributo_opciones (
    ...
    UNIQUE KEY uq_categoria_atributo_opcion
