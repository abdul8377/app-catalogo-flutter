...
import 'package:app_catalogo/features/sync/data/mappers/product_sync_backup_mapper.dart';
...
void main() {
  ...
  test('exporta y restaura las configuraciones completas de SQLite', () async {
    ...
    const productId = 'product-backup-1';
      ...
      'variantes_json': jsonEncode([
        {
          'id': 'variant-1',
          'sku': 'BACKUP-001-U',
          'nombre_corto': 'Producto para respaldo',
    ...
    const mapper = ProductSyncBackupMapper();
