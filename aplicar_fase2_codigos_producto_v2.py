...
if "codigo: CodigoInternoGenerator.nuevoProducto()" not in bloc:
    bloc = regex_once(
        bloc,
        r"""      if \(event\.productoId == null\) \{
\s*emit\(
\s*state\.copyWith\(
.*?
\s*\),
...
\s*\}""",
        ...
        "generar código del producto al iniciar",
    )
bloc = replace_once(
    bloc,
...
print(f"\nRespaldo: {backup_dir}")
print("\nFase 2 aplicada con el detector flexible v2.")
print("Ejecuta:")
