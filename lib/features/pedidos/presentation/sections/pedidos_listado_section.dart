...
class PedidosListadoSection extends StatefulWidget {
  const PedidosListadoSection({
  ...
  @override
  State<PedidosListadoSection> createState() => _PedidosListadoSectionState();
}

class _PedidosListadoSectionState extends State<PedidosListadoSection> {
